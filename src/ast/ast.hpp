...
enum ExprKind {
    ID_EXPR, OP_EXPR, CONST_EXPR, PARAM_EXPR, PROCDCALL, SUBSCRIPT_EXPR, RAND_EXPR, CONST_STR, INITREC_EXPR, RECORD_EXPR
};
...
enum StmtKind {
    VARDECL, FUNCDECL, RECDECL, READSTM, PRINTSTM, ASSIGNSTM, EXPRSTM, WHILESTM, IFSTM, RETURNSTM
};

inline vector<string> StmtKindStr = {
    "VARDECL", "FUNCDECL", "RECDECL", "READSTM", "PRINTSTMT", "ASSIGNSTM", "EXPRSTM", "WHILESTM", "IFSTM", "RETURNSTM"
};
